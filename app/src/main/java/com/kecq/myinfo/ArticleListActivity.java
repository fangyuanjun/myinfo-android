...
public class ArticleListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.article_list_refreshLayout);
                ...
                if(i == SCROLL_STATE_IDLE){
                    ...
                    if(listView.getLastVisiblePosition() == (adapter.getCount() - 1))
                    {
                        ...
                        if(adapter.getCount()<totalItemsCount)
                        {
                            ...
                            new ArticleListActivity.LoadNextDataThread().start();
                        }
                    }
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new ArticleListActivity.LoadDataThread().start();
            }
        });
    }
