...
import com.kecq.myinfo.fragment.MovieListFragment;
...
public class MovieListActivity extends BaseListActivity {
    ...
    private MovieListFragment fragment=null;
    ...
    protected void jumpPlusPage() {
        Intent intent = new Intent(MovieListActivity.this, MyWebViewActivity.class);
        intent.putExtra("id","");
        intent.putExtra("title","添加电影信息");
        intent.putExtra("url",Temp.MyInfoBaseUrl+ SignHelper.SignUserUrl("/MyMovie/Edit/0") );
